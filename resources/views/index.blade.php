...
<div>
    ...
    <div class="container">
     ...
     <div class="container text-center categories text-uppercase">
        <h2>blog categories</h2>
        <div class=" d-flex align-items-center pt-10 justify-content-center flex-wrap">
            ...
            <div class="d-flex bg-warning m-0  col-sm-6 ">
                <div class="d-block m-auto  pt-2 pb-5 ">
                    <ul class="row mr-0 col-sm-12 d-flex px-2  justify-content-between list-unstyled">
                        <li class="col-sm-auto my-2 py-2 px-3 hover-bg  rounded"><a href="/" class="text-decoration-none ">PHP</a></li>
                        <li class="col-sm-auto my-2 py-2 px-3 hover-bg  rounded"><a href="/" class="text-decoration-none ">PROGRAMING</a></li>
                        <li class="col-sm-auto my-2 py-2 px-3 hover-bg  rounded"><a href="/" class="text-decoration-none ">BACKEND</a></li>
                        <li class="col-sm-auto my-2 py-2 px-3 hover-bg  rounded"><a href="/" class="text-decoration-none ">LANGUAGE</a></li>
